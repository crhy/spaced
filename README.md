...
<h1 align="center">Spaced Linux 9.26.2</h1>
...
<p align="center">
  <a href="https://github.com/crhy/spaced/releases/tag/v9.26.2"><strong>Download Spaced Linux 9.26.2</strong></a> ·
  <a href="docs/9.26.2-ISSUE-STATUS.md"><strong>9.26.2 release status</strong></a>
</p>
...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-9.26.2-0ea5e9">
...
<table>
  <tr>
    ...
    <td width="50%" align="center">
      <a href="website/assets/screenshots/desktop-welcome.webp?v=9.26.2"><img src="website/assets/screenshots/desktop-welcome.webp?v=9.26.2" alt="Welcome to Spaced Linux first-run application"></a><br>
...
```bash
sha256sum -c spaced-linux-9.26.2-amd64.iso.sha256
```
...
The current development line is **9.26.2**. Spaced Linux is an independent community project under active development.
