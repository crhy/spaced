...
<h1 align="center">Spaced Linux 7.26.2</h1>
...
<p align="center">
  ...
  <a href="https://github.com/crhy/spaced/releases/tag/v7.26.2"><strong>Download 7.26.2</strong></a> ·
...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-7.26.2-0ea5e9">
...
## Download Spaced Linux 7.26.2

Download the ISO and checksum files from the [Spaced Linux 7.26.2 release](https://github.com/crhy/spaced/releases/tag/v7.26.2).
...
```bash
sha256sum -c spaced-linux-7.26.2-amd64.iso.sha256
```
...
The current release line is **7.26.2**. Spaced Linux is an independent community project under active development.
