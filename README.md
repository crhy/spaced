...
<h1 align="center">Spaced Linux 8.26.4</h1>
...
<p align="center">
  ...
  <img alt="Release" src="https://img.shields.io/badge/release-8.26.4-0ea5e9">
...
<table>
  <tr>
    ...
    <td width="50%" align="center">
      <a href="website/assets/screenshots/desktop-welcome.webp?v=8.26.4"><img src="website/assets/screenshots/desktop-welcome.webp?v=8.26.4" alt="Welcome to Spaced Linux first-run application"></a><br>
...
```bash
sha256sum -c spaced-linux-8.26.4-amd64.iso.sha256
```
...
The current development line is **8.26.4**. Spaced Linux is an independent community project under active development.
